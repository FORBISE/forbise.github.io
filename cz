    ...
    <main class="content">
      ...
      <div class="countdown">
        <div class="countdown__days">
          ...
          <div class="countdown__label">Dny</div>
        </div>
        ...
        <div class="countdown__seconds">
          <div class="countdown__number"></div>
          <div class="countdown__label">Vteřiny</div>
        </div>
      </div>

      <p>Naše webová stránka je ve výstavbě. Brzy tady budeme s naší úžasnou novou webovou stránkou.</p>
    </main>
